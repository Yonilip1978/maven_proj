...
public class KSPfuncPage {


    public KSPfuncPage(WebDriver driver) {
    }
    ...
    private static ExtentSparkReporter getHtmlReporter() {
        ...
        htmlReporter.config().setReportName("Functional & Usability Tests חווית משתמש,מנוע חיפוש,התחברות לאייקונים/לינקים, KSP WebSite");
